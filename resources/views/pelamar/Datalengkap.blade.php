      ...
      <form >
        ...
        <div class="container">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-end mt-5">
            <div class="modal fade" id="buttonunduh" aria-hidden="true"data-bs-backdrop="static" aria-labelledby="buttonunduh1" tabindex="-1">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content"style="border-radius: 40px;">
                  <div class="modal-body text-center mt-5">
                    <i class="bi bi-download" style="color: #F26419; font-size: 50px;" ></i>
                    <p class="mb-5 mt-3">Unduh CV anda sekarang?</p>
                    <div class="row justify-content-center">
                        <div class="col-4">
                          <button class="btn btn-primary" style="background-color: #F26419; width: 120px; height: 40px; border-radius: 20px" data-bs-toggle="modal" data-bs-target="#buttonunduh3" type="button">Unduh</button>
                        </div>
                        <div class="col-4">
                          <button class="btn btn-primary" style="background-color: #F26419; width: 120px; height: 40px; border-radius: 20px" data-bs-dismiss="modal" type="button">Batal</button>
                        </div>
                      </div>
                  </div>
                </div>
            ...
            <div class="modal fade" id="buttonunduh3" aria-hidden="true" aria-labelledby="buttonunduh3" tabindex="-1">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content"style="border-radius: 40px;">
                  <div class="modal-body text-center mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
                    ...
                    <p>CV Anda berhasil diunduh.</p>
                  </div>
                </div>
              </div>
            </div>
            <button class="btn btn-primary" style="background-color: #F26419;" type="button" data-bs-toggle="modal" data-bs-target="#buttonunduh">Unduh cv</button>
            <button class="btn btn-primary" style="background-color: #C5C5C5;" type="button">Simpan</button>
          </div>
