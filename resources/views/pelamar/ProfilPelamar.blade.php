...
{{-- end modal password --}}
      ...
      <form >
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-9">
            <button type="button" class="btn btn-link text-decoration-none" style="background-color: #F26419; color: #ffffff; margin-left: 15%;" onclick="toggleDropdown('pendidikan')">Tambahkan Pendidikan +</button>
            
            <div class="container-fluid" id="pendidikan-dropdown" style="display: none; margin-left: 15%;">
              <br>
              <!-- Isi dropdown untuk Pendidikan -->
              <div class="row mb-3">
                <label for="inputEmail" class="col-sm-2 col-form-label">Jenjang<span style="color: #F26419">*</span></label>
                <div class="col-sm-8" >
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="SD" class="radio-custom-color"> SD
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="SMP" class="radio-custom-color"> SMP
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="SMA" class="radio-custom-color"> SMA
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="SMK" class="radio-custom-color"> SMK
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="D1" class="radio-custom-color"> D3
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="S1" class="radio-custom-color"> S1
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="S2" class="radio-custom-color"> S2
                  <input style="margin-left: 8%;" type="radio" name="Pendidikan" value="S3" class="radio-custom-color"> S3
                  

                </div>
              </div>
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">jurusan<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <input type="text" style="width: 100%;">
                </div>
              </div>  
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label" >Asal Sekolah / Kampus<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <br>
                  <input type="text"  style="width: 100%;">
                </div>
              ...
              <div class="row mb-2">
                <label for="user id" class="col-2 col-form-label">Tahun<span style="color: #F26419">*</span></label>
                <div class="col-sm-3">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-caret-down" style="color: #F26419;"></i></span>
                    </div>
                    <select id="tahunAwalDropdown" class="form-control">
                      
                      <?php
                        $tahunSaatIni = date("Y");
                        for ($tahun = 2020; $tahun <= $tahunSaatIni; $tahun++) {
                ...
                <div class="col-2 text-center">
                  <span style="font-size: 16px; margin-top: 5px;">sampai</span>
                </div>
                <div class="col-sm-3">
                  <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <select id="tahunAkhirDropdown" class="form-control">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-start mt-5">
                <button class="btn btn-primary" style="background-color: #F26419;" type="button">tambahkan</button>
                <button class="btn btn-primary" style="background-color: #14AE5C;" type="button">Simpan</button>
              </div>
               <br>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            <button type="button" class="btn btn-link text-decoration-none" style=" background-color: #F26419; color: #ffffff; margin-left: 17% ;" onclick="toggleDropdown('organisasi')">Tambahkan Organisasi +</button>
            
            <div class="container-fluid" id="organisasi-dropdown" style="display: none; margin-left: 17%;">
              <br>
              <!-- Isi dropdown untuk Organisasi -->
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Nama Organisasi<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <input type="text" style="width: 100%;">
                </div>
              </div>  
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Jabatan<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <input type="text" style="width: 100%;">
                </div>
              </div> 
              ...
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Deskripsi<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-start mt-5">
                <button class="btn btn-primary" style="background-color: #F26419;" type="button">tambah</button>
                <button class="btn btn-primary" style="background-color: #14AE5C;" type="button">Simpan</button>
              </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            <button type="button" class="btn btn-link text-decoration-none" style="background-color: #F26419; color: #ffffff; margin-left: 17% ;" onclick="toggleDropdown('pengalaman')">Tambahkan Pengalaman Kerja +</button>
            
            <div class="container-fluid" id="pengalaman-dropdown" style="display: none; margin-left: 17%;">
              <br>
              <!-- Isi dropdown untuk Pengalaman Kerja -->
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Pekerjaan<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">

                    <select class="form-select form-select-sm" id="floatingSelect" aria-label="Floating label select example" placeholder="Select">
                      <option value="1">UI/UX Designer</option>
                      <option value="2">Programmer</option>
                      <option value="3">Programmer</option>
                      <option value="4">Social Media Specialist</option>
                      <option value="5">Content Writer</option>
                      <option value="6">Desain Grafis</option>
                      <option value="7">Digital Market</option>
              ...
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Nama Perusahaan<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <br>
                  <input type="text" style="width: 100%;">
                </div>
              ...
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">No.telepon Perusahaan<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <br>
                  <input type="text" style="width: 100%;">
                </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            <button type="button" class="btn btn-link text-decoration-none" style=" background-color: #F26419; color: #ffffff; margin-left: 17% ;" onclick="toggleDropdown('skill')">Tambahkan Skill +</button>
            
            <div class="container-fluid" id="skill-dropdown" style="display: none; margin-left: 17%; ">
              <br>
              <!-- Isi dropdown untuk Skill -->
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">skils<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
                  <input type="text" style="width: 100%;">
                </div>
              </div>  
              ...
              <div class="row mb-3">
                <label for="user id" class="col-2 col-form-label">Experience Level<span style="color: #F26419">*</span></label>
                <div class="col-sm-8">
        ...
        <div class="container">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-end mt-5">
            ...
            <button class="btn" style="background-color: #C5C5C5;" type="button">Unduh cv</button>
            <button class="btn" style="background-color: #14AE5C;" type="button" data-bs-toggle="modal" data-bs-target="#buttonsave">Simpan</button>
          </div>
...
<!-- Bootstrap JS (make sure to include this after the modal HTML) -->
