...
<div class="container-fluid">
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-9">
            ...
            <p class="text-center">Masukan email untuk mengatur ulang kata sandi Anda</p>
            

            <form>

                <div class="mb-3">
                    <input type="email" class="form-control" id="email" style="border: 2px solid black" placeholder="Email" required>
                </div>
                
            <div class="text-center">
                {{-- <button type="submit" class="btn btn-primary" style="background-color: #F26419; padding: 5px 80px; border-radius: 5px;">KIRIM</button> --}}
            
                <a class="btn" style="background-color: #F26419; color: aliceblue; padding: 5px 80px; border-radius: 5px;"  href="/lupaPwValidasi ">Kirim</a>
            </div>
            </form>
