...
@section('css')
    ...
    {{-- my style css --}}
    <link rel="stylesheet" type="text/css" href="assets/css/perusahaan/tambahAlamatBaru.css">
    {{-- icons --}}
    ...
    <div class="container" style="width: 80%; margin: auto">
        ...
        <div class="list-alamat" style="overflow: auto; scrollbar: none;">
            <div class="card-alamat" style="background-color: #FFF7E4; border: none">
                ...
                <button type="button" class="btn btn-sm" style="background-color: rgba(255, 152, 55, 1); color: white;font-weight: 500; width: 180px; margin-bottom: 5px; display: block; margin: auto;"  id="simpan-alamat">Simpan Alamat Baru <i class="fa fa-check" aria-hidden="true"></i></button>
            ...
            $(document).click(function(e) {
                $("#simpan-alamat").click(function(e) {
                    swal({
                        ...
                        title: "Kamu yakin untuk menambahkan alamat baru ini?",
