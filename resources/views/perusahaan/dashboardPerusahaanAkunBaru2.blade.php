...
@section('css')
    ...
    {{-- my style css --}}
    <link rel="stylesheet" type="text/css" href="assets/css/perusahaan/dashboardPerusahaanAkunBaru2.css">
    {{-- icons --}}
                ...
                <div class="col-lg-8 lowongan-saya">
                    ...
                    <div class="row wadah-post-lowongan">
                        <div class="col-lg-8" style="display: flex;">
                            <img src="assets/img/logo-seven-inc.png" width="85px">
                            <img src="assets/img/vector-vertical-lowongan.png" height="60px" style="margin-top: 15px">
                        ...
                        <div class="col-lg-4 " style="display: flex; justify-content: end; padding: 15px;">
                            <span style="margin-top: auto; margin-bottom: auto;">
                                <div class="btn btn-sm" style="background-color: white; color: #A5A5A5; border: 1px solid #A5A5A5; font-weight: 500; ">Silver</div>
                                <button type="button" class="btn btn-sm" style="background-color: rgba(255, 152, 55, 1); color: white; font-weight: 500; margin-left: ;">Lihat Pelamar</button>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 side-right">
                    <div class="container" style="background-color: rgba(255, 247, 228, 1); border-radius: 10px; padding: 15px">
                        <div class="notifikasi">
                            ...
                            <div class="row">
                                <div class="col-lg-3"><img src="assets/icon-img/icon-orang-pojok-AK.png" ></div>
                                <div class="col-lg-9">
